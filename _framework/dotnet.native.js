...
// include: /home/Jamnior/.dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/10.0.12/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
...
// end include: /home/Jamnior/.dotnet/packs/Microsoft.NETCore.App.Runtime.Mono.browser-wasm/10.0.12/runtimes/browser-wasm/native/src/es6/dotnet.es6.pre.js
...
var ASM_CONSTS = {
  1626340: () => { if (document.fullscreenElement) return 1; },  
 1626386: () => { return document.getElementById('canvas').width; },  
 1626438: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1626506: () => { document.exitFullscreen(); },  
 1626533: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 1626606: () => { if (document.fullscreenElement) return 1; },  
 1626652: () => { return document.getElementById('canvas').width; },  
 1626704: () => { return screen.width; },  
 1626729: () => { document.exitFullscreen(); },  
 1626756: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 1626889: () => { return window.innerWidth; },  
 1626915: () => { return window.innerHeight; },  
 1626942: () => { if (document.fullscreenElement) return 1; },  
 1626988: () => { return document.getElementById('canvas').width; },  
 1627040: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1627108: () => { if (document.fullscreenElement) return 1; },  
 1627154: () => { return document.getElementById('canvas').width; },  
 1627206: () => { return screen.width; },  
 1627231: () => { return window.innerWidth; },  
 1627257: () => { return window.innerHeight; },  
 1627284: () => { if (document.fullscreenElement) return 1; },  
 1627330: () => { return document.getElementById('canvas').width; },  
 1627382: () => { return screen.width; },  
 1627407: () => { document.exitFullscreen(); },  
 1627434: () => { if (document.fullscreenElement) return 1; },  
 1627480: () => { return document.getElementById('canvas').width; },  
 1627532: () => { return parseInt(document.getElementById('canvas').style.width); },  
 1627600: () => { document.exitFullscreen(); },  
 1627627: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 1627685: () => { return screen.width; },  
 1627710: () => { return screen.height; },  
 1627736: () => { return window.screenX; },  
 1627763: () => { return window.screenY; },  
 1627790: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 1627843: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 1627914: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 1627971: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 1628227: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 1628298: () => { if (document.fullscreenElement) return 1; },  
 1628344: () => { return window.innerWidth; },  
 1628370: () => { return window.innerHeight; },  
 1628397: () => { if (document.pointerLockElement) return 1; }
};
...
var _mono_aot_RaylibWasm_get_method = Module['_mono_aot_RaylibWasm_get_method'] = (a0) => (_mono_aot_RaylibWasm_get_method = Module['_mono_aot_RaylibWasm_get_method'] = wasmExports['mono_aot_RaylibWasm_get_method'])(a0);
